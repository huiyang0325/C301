"""测试VAEDecode with simple inputs"""
import json, httpx, asyncio

async def main():
    # Check if VAEDecode works with proper model linking
    prompt = {
        ...
        '6': {'class_type': 'KSampler', 'inputs': {'model': ['1', 0], 'positive': ['5', 0], 'negative': ['5', 0], 'latent_image': ['4', 0], 'seed': 0, 'steps': 1, 'cfg': 1, 'sampler_name': 'euler', 'scheduler': 'simple', 'denoise': 1}},
        '7': {'class_type': 'VAEDecode', 'inputs': {'samples': ['6', 0], 'vae': ['3', 0]}},
        '8': {'class_type': 'SaveImage', 'inputs': {'images': ['7', 0], 'filename_prefix': 'test'}},
    }

    print("Submitting simple VAEDecode test...")
