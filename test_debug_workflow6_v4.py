...
async def main():
    ...
    # Check for node 8 in prompt
    print(f"Node 8 in prompt: {'8' in prompt}")
    if '8' in prompt:
        print(f"Node 8: {prompt['8']}")

    # Get object_info for VAEDecode
    print("\nVAEDecode input_order:", object_info.get('VAEDecode', {}).get('input_order'))
    print("VAEDecode is_input_list:", object_info.get('VAEDecode', {}).get('is_input_list'))

    # Submit and print full error
