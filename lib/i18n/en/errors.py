MESSAGES = {
    ...
    "long_video_task_submitted": "Long video generation task submitted with {count} segments",
    "arrangement_not_found": "Arrangement file not found (episode {episode})",
    "no_storyboard_images_found": "No available storyboard images found",
