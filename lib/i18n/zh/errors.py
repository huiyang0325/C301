MESSAGES = {
    ...
    "long_video_task_submitted": "长视频生成任务已提交，使用 {count} 个分镜",
    "arrangement_not_found": "编排文件不存在 (episode {episode})",
    "no_storyboard_images_found": "未找到可用的分镜图",
    "video_backend_not_configured": "视频 backend 未配置",
