...
export default {
  ...
  'agent_config_saved': '奶糖科技 Agent configuration saved',
  'field_cleared': 'cleared',
  'api_key_mgmt': 'API Key Management',
  'api_key_usage_desc': 'Used to access 奶糖科技 projects from external tools (e.g. OpenClaw 🦞).',
  ...
  // config-status-store
  'agent_api_key_not_configured': '奶糖科技 Agent API Key (Anthropic) not configured',
  ...
  'longvideo_tab': 'Long Video Arrange',
  'move_up': 'Move Up',
  'move_down': 'Move Down',
  'delete_segment': 'Delete Segment',
  'confirm_delete_segment': 'Are you sure you want to delete this segment? This action cannot be undone.',
  'longvideo_arrange_hint': 'Long video arrangement is independent and will not affect the original script',
  'reset_arrangement': 'Reset Arrangement',
  'generate_long_video': 'Generate Long Video ({{count}} frames · ~{{duration}}s)',
  'long_video_generated': 'Long video generated successfully using {{count}} segments',
  'video_backend_not_configured': 'Video backend not configured',
  'no_storyboard_images_found': 'No storyboard images found',
  'arrangement_not_found': 'Arrangement file not found',
  'long_video_preview': 'Long Video Preview',
  'no_long_video_yet': 'No long video yet',
  'long_video_task_submitted': 'Long video task submitted with {{count}} segments',
  'long_video_ready': 'Long video ready',
  'long_video_timeout': 'Long video generation timed out (2 min), please refresh later',
