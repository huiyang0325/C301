...
export default {
  ...
  'agent_config_saved': '奶糖科技 智能体配置已保存',
  'field_cleared': '已清除',
  'api_key_mgmt': 'API 密钥管理',
  'api_key_usage_desc': '用于从外部工具（如 OpenClaw 🦞）访问奶糖科技 项目。',
  ...
  // config-status-store
  'agent_api_key_not_configured': '奶糖科技 智能体 API Key（Anthropic）未配置',
  ...
  'move_down': '下移',
  'delete_segment': '删除分镜',
  'confirm_delete_segment': '确定要删除该分镜吗？此操作不可撤销。',
  'longvideo_arrange_hint': '长视频编排已独立，不影响原始剧本',
  'reset_arrangement': '重置编排',
  'generate_long_video': '生成长视频（共 {{count}} 帧 · 预计 {{duration}}s）',
  'long_video_generated': '长视频生成成功，使用了 {{count}} 个分镜',
  'video_backend_not_configured': '未配置视频 backend',
  'no_storyboard_images_found': '未找到分镜图',
  'arrangement_not_found': '编排文件不存在',
  'long_video_preview': '长视频预览',
  'no_long_video_yet': '暂无长视频',
  'long_video_task_submitted': '长视频任务已提交，使用 {{count}} 个分镜',
  'long_video_ready': '长视频生成完成',
  'long_video_timeout': '长视频生成超时（2分钟内未完成），请稍后刷新页面',
