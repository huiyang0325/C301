...
MESSAGES: dict[str, str] = {
    ...
    "provider_desc_comfyui": "Local ComfyUI workflow engine supporting high-quality image and video generation through custom workflows.",
}
